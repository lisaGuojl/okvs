...
OBD2Tables::OBD2Tables(int hashSize, double c1, int fieldSize, int gamma, int v, int firstsd, int secondsd) : OBDTables(hashSize, c1, fieldSize, gamma, v){
...
{   
    ...
    //    cout<<"items in set = "<<hashSize*factorSize<<endl;
    //    cout<<"items in 3 sets = "<<3*hashSize*factorSize<<endl;
    vector<double> factorSize = {2.4 / 2, 1.3 / 3};
    first = unordered_set<uint64_t, Hasher>(twohashSize * factorSize[0], Hasher(firstSeed));
    second = unordered_set<uint64_t, Hasher>(twohashSize * factorSize[0], Hasher(secondSeed));

    third = unordered_set<uint64_t, Hasher>(threehashSize * factorSize[1], Hasher(thirdSeed));
    fourth = unordered_set<uint64_t, Hasher>(threehashSize * factorSize[1], Hasher(fourthSeed));
    fifth = unordered_set<uint64_t, Hasher>(threehashSize * factorSize[1], Hasher(fifthSeed));

    third.max_load_factor(3);
    fourth.max_load_factor(3);
    ...
    // cout << twotableRealSize << ", " << threetableRealSize << endl;
...
void OBDHybTables::fillTables()
{
    ...
    for (int i = twohashSize; i < hashSize; i++)
    {
        third.insert(keys[i]);
    ...
    for (int position = 0; position < threetableRealSize; position++)
    {
        ...
        if (result == true)
        {
            ...
            if (bucketInd + pos >= twotableRealSize && bucketInd + pos < 2 * twotableRealSize)
            {
                ...
                if (result == true)
                {
                    queueSecond.push(bucketInd + pos - twotableRealSize);
                }
            }
    ...
    for (int position = 0; position < threetableRealSize; position++)
    {
        ...
        if (result == true)
        {
            ...
            if (bucketInd + pos + threetableRealSize >= twotableRealSize && bucketInd + pos + threetableRealSize < 2 * twotableRealSize)
            {
                ...
                if (result == true)
                {
                    queueSecond.push(bucketInd + pos + threetableRealSize - twotableRealSize);
                }
            }
            else if (bucketInd + pos + threetableRealSize < twotableRealSize)
            {
                ...
                if (result == true)
                {
                    queueFirst.push(bucketInd + pos + threetableRealSize);
                }
            }
        }
    }
                                    ...
                                    queue<int> &queueOther4, unordered_set<uint64_t, Hasher> &other4)
{
    ...
    for (int i = 0; i < queueMain.size(); i++)
    {
        int bucketId = queueMain.front();
        queueMain.pop();
        if (main.bucket_size(bucketId) == 1)
        {
            auto key = *main.begin(bucketId);
            main.erase(key);
            ...
            else if (bucketInd + twotableRealSize < pos + threetableRealSize)
            {
                ...
                {
                    queueOther2.push(bucketInd + twotableRealSize - pos);
                }
            }
            else if (bucketInd + twotableRealSize < pos + 2 * threetableRealSize)
            {
                ...
                {
                    queueOther3.push(bucketInd + twotableRealSize - pos - threetableRealSize);
                }
            }
            else if (bucketInd + twotableRealSize < pos + 3 * threetableRealSize)
            {
                ...
                {
                    queueOther4.push(bucketInd + twotableRealSize - pos - 2 * threetableRealSize);
                }
            }
        }
    }
    ...
    for (int i = 0; i < queueMain.size(); i++)
    {
        ...
        if (main.bucket_size(bucketId) == 1)
        {
            ...
            else if (bucketInd < pos + threetableRealSize)
            {
                ...
                {
                    queueOther2.push(bucketInd - pos);
                }
            }
            else if (bucketInd < pos + 2 * threetableRealSize)
            {
                ...
                {
                    queueOther3.push(bucketInd - pos - threetableRealSize);
                }
            }
            else if (bucketInd < pos + 3 * threetableRealSize)
            {
                ...
                {
                    queueOther4.push(bucketInd - pos - 2 * threetableRealSize);
                }
            }
        }
    }
    ...
    for (int i = 0; i < queueMain.size(); i++)
    {
        ...
        if (main.bucket_size(bucketId) == 1)
        {
            ...
            else if (bucketInd + pos + threetableRealSize >= twotableRealSize)
            {
                ...
                {
                    queueOther2.push(bucketInd + pos + threetableRealSize - twotableRealSize);
                }
            }
            else
            {
            ...
            else if (bucketInd + pos + 2 * threetableRealSize >= twotableRealSize)
            {
                ...
                {
                    queueOther2.push(bucketInd + pos + 2 * threetableRealSize - twotableRealSize);
                }
            }
            else
            {
                ...
                {
                    queueOther1.push(bucketInd + pos + 2 * threetableRealSize);
                }
            }
        }
    }
    ...
    for (int i = 0; i < queueMain.size(); i++)
    {
        ...
        if (main.bucket_size(bucketId) == 1)
        {
            ...
            else if (bucketInd + pos >= twotableRealSize)
            {
                ...
                {
                    queueOther2.push(bucketInd + pos - twotableRealSize);
                }
            }
            else
            {
